...
client.on('message', async message => {
 ...
 message.channel.send('Вам нужно ввести допустимую команду!')
 }
});
...
function skip(message, serverQueue) {
 ...
 if (!serverQueue) return message.channel.send('Нет такой песни, которую я мог бы пропустить!');
...
client.login("NjA1MzQ4ODM0ODcyMjYyNjY2.Xo9skQ.tDarlPVeT6ZKzWABz0VJVFAXN30");